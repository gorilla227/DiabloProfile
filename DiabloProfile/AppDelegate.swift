...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        NotificationCenter.default.addObserver(self, selector: #selector(autoSaveBackgroundManagedObjectContext), name: NSNotification.Name.NSManagedObjectContextDidSave, object: mainManagedObjectContext)
        Timer.scheduledTimer(timeInterval: 10, target: self, selector: #selector(autoSaveBackgroundManagedObjectContext), userInfo: nil, repeats: true)
        if let font = UIFont(name: "DiabloHeavy", size: 20) {
            UINavigationBar.appearance().titleTextAttributes = [NSFontAttributeName: font, NSForegroundColorAttributeName: UIColor.brown]
    ...
    lazy var managedObjectModel: NSManagedObjectModel = {
        ...
        let modelURL = Bundle.main.url(forResource: "DiabloProfile", withExtension: "momd")!
